...
ES_Event RunTopHSM(ES_Event ThisEvent)
{
    ...
    //USED TO DELAY IR SIGNAL IN TAPE FOLLOW
    static int IR_TAPE_FLAG = 0;
    //0 for forward 1 for reverse
    static int TAPEDIR = 0;
    static int JIG = 0;
    static int IN_FIELD = 0;
    static int BUMPCOUNTFORTAPEBR = 0;
    static int BUMPCOUNTFORTAPEFR = 0;
    static int DIR = 0;
    ...
    case InitPState: // If current state is initial Pseudo State
        ...
        //BEGINING STATE TO LOOK FOR FIRST TOWER
    case Rotating:
    ...
    case Traversing:
        ...
        case ES_EXIT:
            ...
            //STOP THIS TIMER SO IM ADJUSTING IT CAN BE REUSED WITHOUT CAUSING ISSUES
    ...
    case Shooting:
        ...
        /*USED AS A LAST DITCH EFFORT TO YEET THY BALL IN HOLE BY WHIPING OUR HEAD AND TAIL BACK */
    case Jiggle:
        switch (ThisEvent.EventType) {
        case ES_ENTRY:
        ...
        //THIS IS USED TO CIRCUNAVIGATE THE TOWER IN REVERSE IN ORDER TO POINT IR SENSOR AWAY FROM
        //CURRENT TOWER
    case NextTower:
        //InitRotateAroundTowerSubHSM();
        ThisEvent = RunRotateAroundTowerHSM(ThisEvent);
        ...
        //USED AS TAPE AVOIDANCE INTERMITERDARY STATE FOR AT TOWER, THE ROBOT WILL SEEK TAPE ANDO ONCE 
        //FOUND THE BOT WILL EITHER TRAVERSE CCW OR CW
    ...
    case CurveForTape:
        ...
        //THIS STATE IS USED ONCE THE BOT FINDS THE CORRECT FACE AND HAS COMPLETED ITS ALIGNMENT TO BE AS
        //PARLLEL AS POSSIBLE IT WILL DRIVE FORWARD AND BACKWARDS USING ITS LIGHT SENSORS AS SIGNALS
        //TO SWITCH DIRECTION WHEN THEY GO OFF TOWERS FACE
    case FindTape:
        ...
        case ES_ENTRY:
            ...
            //ENTRY INTO THIS STATE IS TO DRIVE OFF THE FACE HEAD FIRST
            /*
             THE WEAKNESS OF THIS CODE IS IT DEPENDS ON A OFF EVENT FROM ONE OF THE L OR R FACE 
             *TAPE SENSORS, SHOULD HAVE SOME KINDA OF ESCAPE SEQUENCE MAYBE JUST SEND TAPE EVENTS TO
             TAPE FOLLOW*/
            LeftMtrSpeed(64, FORWARD);
            RightMtrSpeed(64, FORWARD);
            //INIT WATCH DOG TIMER TO CATCH ROBOT INCASE ITS TOO FAR FORWARD FOR THIS ENTRY CODE
            ...
            /*ALL BUMP EVENTS IN THIS STATE ARE USED TO AJUST THE BOT AS CLOSE AS POSSIBLE TO THE FACE
             INCREASING THE PROBABILITY OF THE BALL GOING IN*/
        case FRONT_R_BUMP:
            BUMPCOUNTFORTAPEFR = 1;
        ...
        case OFF_TOWER_R:
            //THIS FLAG IS USED TO GIVE DUAL FUNCTIONALITY TO OFF_TOWER_L EVENT
            /*THE FLAG IS SET HIGH TO RETURN OFF_TOWER_L TO NORMAL EXPECTED FUNCTION*/
            TAPEDIR = 1;
            ES_Timer_StopTimer(GIVE_UP_ON_TOWER_TIMER);
            StopMotors();
        ...
        case OFF_TOWER_L:
            ...
            //THIS IS THE TRANSITION OUT OF THIS STATE
        case TOWER_TAPE_C_ALIGN:

            if (BUMPCOUNTFORTAPEBR == 1 && BUMPCOUNTFORTAPEFR == 1 ) {
                StopMotors();
                BUMPCOUNTFORTAPEFR = 0;
                BUMPCOUNTFORTAPEBR = 0;
                TAPEDIR = 0;
                nextState = Shooting;
                makeTransition = TRUE;
